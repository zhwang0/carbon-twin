...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, cross):
        ...
        batch = x.shape[0] # [32, 7, 1, 256]
        x = self.self_attention(x) # [32, 7, 1, 256]
        x = rearrange(x, 'b ts_d out_seg_num d_model -> (b ts_d) out_seg_num d_model') # [32*7, 1, 256]
        
        cross = rearrange(cross, 'b ts_d in_seg_num d_model -> (b ts_d) in_seg_num d_model') # [32*136, 1, 256]
